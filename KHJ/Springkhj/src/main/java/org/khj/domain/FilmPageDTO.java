...
public class FilmPageDTO {
	...
	private filmCriteria fcri;
	
	public FilmPageDTO(filmCriteria fcri, int total){
	this.fcri = fcri;
	this.total = total;
	...
	int realEnd = (int)(Math.ceil((total*10)/fcri.getAmount()));
	...
	public filmCriteria getFcri() {
		return fcri;
	}

	public void setFcri(filmCriteria fcri) {
		this.fcri = fcri;
	}

	@Override
	public String toString() {
		return "FilmPageDTO [startPage=" + startPage + ", endPage=" + endPage + ", prev=" + prev + ", next=" + next
				+ ", total=" + total + ", fcri=" + fcri + "]";
	}
